...
2. If `"isPreFillAmount": true`, then user will be directly prompted for payment. <br>
![Prompt Payment](https://storage.googleapis.com/rm-portal-assets/img/rm-doc/transaction-qr/2.jpeg)

3. Key in payment pin to complete payment. <br>
![Complete Payment](https://storage.googleapis.com/rm-portal-assets/img/rm-doc/transaction-qr/3.jpeg)

4. User will get payment status notification. <br>
![Successful Payment](https://storage.googleapis.com/rm-portal-assets/img/rm-doc/transaction-qr/4.jpeg)

5. User will be redirected to `redirectUrl` specified during QR code creation. <br>

6. User will also get this notification in Service Notification. <br>
...
7. Merchant can view the transaction record in Merchant Portal. <br>
...
<code>method</code> | []String | No | Wallet provider for payment, currently supports "WECHATPAY" and "PRESTO". Default is all supported wallets. | ["WECHATPAY"]
...
<code>method</code> | []String | Currently only support "WECHATPAY" and "PRESTO" | ["WECHATPAY"]
