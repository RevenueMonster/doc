...
| <code>method</code>          | []String | No       | Wallet provider for payment, supports "WECHATPAY", "PRESTO" , "BOOST" , "Alipay" and "Gradpay".                                    | ["WECHATPAY","WECHATPAY_MY", <br/> "WECHATPAY_CN","PRESTO_MY",<br/>"BOOST_MY",<br/>"ALIPAY_CN","GRADPAY_MY"] |
...
| <code>method</code>          | []String | Wallet provider for payment, supports "WECHATPAY", "PRESTO" , "BOOST" , "Alipay" and "Gradpay". | ["WECHATPAY","WECHATPAY_MY", <br/> "WECHATPAY_CN","PRESTO_MY",<br/>"BOOST_MY",<br/>"ALIPAY_CN","GRADPAY_MY"] |
